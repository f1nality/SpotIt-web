...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique(u'core_user', ['email'])

        # Adding unique constraint on 'User', fields ['phone_number']
        db.create_unique(u'core_user', ['phone_number'])
    ...
    def backwards(self, orm):
        # Removing unique constraint on 'User', fields ['phone_number']
        db.delete_unique(u'core_user', ['phone_number'])

        # Removing unique constraint on 'User', fields ['email']
        db.delete_unique(u'core_user', ['email'])
