...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'core_device', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='devices', to=orm['core.User'])),
        ...
        # Adding field 'User.device_id'
        db.add_column(u'core_user', 'device_id',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'User.device_id'
        db.delete_column(u'core_user', 'device_id')
    ...
    models = {
        ...
        u'core.device': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'devices'", 'to': u"orm['core.User']"})
        },
        u'core.user': {
